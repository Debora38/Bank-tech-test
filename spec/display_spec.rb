...
RSpec.describe Display do
  ...
  context "#print_statement" do
    it 'should print out the history of my account: one deposit' do
      ...
      allow(account_history).to receive(:all_transactions).and_return([{date: '04/02/2019', credit: '2000.00', debit: '', balance: '2000.00'}])
    ...
    it 'should print out the history of my account: multiple transactions' do
      account_history = double('account_history')
      display = Display.new(account_history)
      allow(account_history).to receive(:all_transactions).and_return([{date: '04/02/2019', credit: '', debit: '500.00', balance: '1500.00'}, {date: '04/02/2019', credit: '2000.00', debit: '', balance: '2000.00'}])
